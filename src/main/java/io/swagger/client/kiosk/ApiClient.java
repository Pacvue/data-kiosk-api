...
import io.swagger.client.kiosk.auth.ApiKeyAuth;
import io.swagger.client.kiosk.auth.Authentication;
import io.swagger.client.kiosk.auth.HttpBasicAuth;
import io.swagger.client.kiosk.auth.OAuth;
import okhttp3.Call;
...
public class ApiClient {
    ...
    */
     ...
     */
    public Call buildCall(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String[] authNames, ProgressRequestBody.ProgressRequestListener progressRequestListener) throws
     ...
     * @throws LWAException If calls to fetch LWA access token fails
     */
    public Request buildRequest(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, Object> formParams, String[] authNames, ProgressRequestBody.ProgressRequestListener progressRequestListener) throws
        ApiException, LWAException {
        ...
        if(progressRequestListener != null && reqBody != null) {
            ProgressRequestBody
                progressRequestBody = new ProgressRequestBody(reqBody, progressRequestListener);
